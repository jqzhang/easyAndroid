package com.brothers.base.ui.tablayout;
...
import com.brothers.base.ui.tablayout.listener.OnTabSelectListener;
import com.brothers.base.ui.tablayout.utils.FragmentChangeManager;
import com.brothers.base.ui.widget.message.MessageViewUtils;
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    public void showMsg(int position, int num) {
        ...
        MessageView tipView = (MessageView) tabView.findViewById(R.id.rtv_msg_tip);
        if (tipView != null) {
            MessageViewUtils.show(tipView, num);
     ...
     */
    public MessageView getMsgView(int position) {
        if (position >= mTabCount) {
            position = mTabCount - 1;
        }
        View tabView = mTabsContainer.getChildAt(position);
