...
public abstract class BaseVlayoutActivity extends BaseActivity implements IBaseVlayoutListView {
    ...
    protected void setContentBackground(Drawable backgroundDrawable) {
        getBaseVlayoutListViewHolder().setContentBackground(backgroundDrawable);
    }
